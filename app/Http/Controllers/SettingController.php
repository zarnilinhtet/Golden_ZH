...
class SettingController extends Controller
{
    public function store(Request $request)
    {
        ...
        $location = Warehouse::find($request->branch_id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $location = Warehouse::find($request->branch_id);
        return redirect(url('setting'))->with('success', 'Update Successfully!');
    }
    public function index()
    {
        ...
        $transactions = Transaction::latest()->get();
        return view('setting.setting', compact('settings', 'transactions', 'branches', 'transactions', 'invoice', 'invoice_return', 'exchange_order', 'eo_return', 'pos'));
    }
