        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"> Price Percent
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="ml-2 container-fluid">
                    @if (in_array('Price Percent Register', $userPermissions) || auth()->user()->is_admin == '1')
                        <div class="row">
                            <div class="mr-auto col"> <button type="button" class="mr-auto btn btn-primary "
                                    data-toggle="modal" data-target="#modal-lg">
                                    Register New Percent
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color:  #007bff26">
                                    <h4 class="modal-title"> Register Percent
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                </div>
                                <div class="modal-body" style="background-color:  #007bff26">
                                    <form action="{{ url('price_percent_store') }}" method="POST">
                                        @csrf
                                        <div class="card-body">

                                            <div class="form-group">
                                                <label for="name">Price Percent <span
                                ...
                                <div class="modal-footer justify-content-between" style="background-color:  #007bff26">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($all_prices as $price)
                                            <tr>
                                                <td>{{ $no++ }}</td>
                                                <td>{{ $price->percent }}</td>
                                                <td>{{ $price->warehouse->name ?? '' }}</td>
                                                <td>
                                                    <div class="row">
                                                        @if (in_array('Price Percent Edit', $userPermissions) || auth()->user()->is_admin == '1')
                                                            <a href="{{ url('price_edit', $price->id) }}"
                                                                class="btn btn-success btn-sm"> <i
                                                                    class="fa-solid fa-pen-to-square"></i></a>
                                                        @endif
                                                        @if (in_array('Price Percent Delete', $userPermissions) || auth()->user()->is_admin == '1')
                                                            <a href="{{ url('price_delete', $price->id) }}"
                                                                onclick="return confirm('Are you sure you want to delete this percent?')"
                                                                class="btn mx-2 btn-danger btn-sm">
