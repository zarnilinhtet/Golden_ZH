                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        @if (in_array('Location Delete', $userPermissions) || auth()->user()->is_admin == '1')
                                                            @if ($warehouse->from_location || $warehouse->to_location)
                                                                <a href="" title="Location Delete"
                                                                    class="btn btn-danger"
                                                                    onclick="alert('This warehouse has items transfered to other locations. You can not delete this location.')"><i
