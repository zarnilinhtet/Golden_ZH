                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item">Brand Management
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@if (in_array('Brand Register', $userPermissions) || auth()->user()->is_admin == '1')
                    <div class="row">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title"> Register New Brand</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form action="{{ url('brand_store') }}" method="POST">
                                        @csrf
                                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($brand as $brands)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        @if (in_array('Brand Edit', $userPermissions) || auth()->user()->is_admin == '1')
                                                        <a href="{{ url('brand_edit', $brands->id) }}"
                                                            title="Brand Edit" class="mx-2 btn btn-success"><i
                                                                class="fa-solid fa-pen-to-square"></i></a>
                                                        @endif
@if (in_array('Brand Delete', $userPermissions) || auth()->user()->is_admin == '1')
                                                            <a href="{{ url('brand_delete', $brands->id) }}"
                                                                title="Brand Delete" class="mx-2 btn btn-danger"
