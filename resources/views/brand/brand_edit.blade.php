                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title  " style="font-weight: bold;">Brand Edit</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" required
                                                    autofocus name="name" value="{{ $brand->name }}">
                                            </div>
                                                    ...
                                                    <select name="branch" id="branch" class="form-control" required>
                                                        ...
                                                        @foreach ($branches as $branch)
                                                            <option value="{{ $branch->id }}"
                                                                {{ $branch->id == $brand->branch ? 'selected' : '' }}>
                                                                {{ $branch->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="description" cols="10" rows="3" class="form-control">{{ $brand->description }}</textarea>
                                            </div>
