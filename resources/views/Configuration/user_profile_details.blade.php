                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"> Configuration Details
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title " style="font-weight: bold;">Profile Details</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" required
                                                    autofocus name="name" value="{{ $user_profile->name }}" readonly>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" id="" cols="30" rows="5" class="form-control" readonly>{{ $user_profile->address }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="name">Description</label>
                                                <textarea name="description" id="" cols="30" rows="2" class="form-control" readonly>{{ $user_profile->description }}</textarea>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" class="form-control" id="phone_number1"
                                                            name="phno1" value="{{ $user_profile->phno1 }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
