                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item">Invoice Record
                                        ...
                                        @foreach ($invoices as $invoice)
                                            @foreach ($invoice->sells as $sell)
                                                @if ($invoice->status === 'invoice')
                                                    @if ($item_variation->id == $sell->variation_id)
                                                        <tr>
                                                            ...
                                                            <td>{{ $sell->product_qty . $sell->unit }}</td>

                                                            <td>{{ $sell->created_at ? $sell->created_at->format('d/m/Y') : '' }}
