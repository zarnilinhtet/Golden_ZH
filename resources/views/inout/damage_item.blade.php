                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item">Damage Item
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title"> Damage Item</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <input type="text" class="mt-3 form-control" id="in_out"
                                                value="out" name="in_out" style="display: none">
                                    ...
                                    @foreach ($inouts as $inout)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                @if ($level1qty == 0 && $level2qty == 0 && is_numeric($level3qty))
                                            ...
                                            <td><a href="{{ url('display_print/' . $inout->id, $inout->item_variation_id) }}"
