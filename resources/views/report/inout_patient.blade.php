            ...
            <section class="content">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="mb-2 row">
                            <div class="col-sm-6">
                                <h1>IN/OUT Patient</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item">IN/OUT Patient
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="ml-2 container-fluid">
                    ...
                    <div class="mt-3 col-md-12">
                        <div class="col-md-6">
                            <form action="{{ url('inout_patient_search') }}" method="get">
                                <div class="row">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">IN/OUT Patient Table</h3>
                                <div class="dropdown ml-auto mr-5">
                                    ...
                                    <div id="branchDropdown" class="dropdown ml-auto"
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a href="{{ url('inout_patient') }}" class="dropdown-item">All
                                                Type</a>
                                            @foreach ($branch_drop as $drop)
                                                <a class="dropdown-item"
                                                    href="{{ route('inout_patient', $drop) }}">{{ $drop }}</a>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($customers as $customer)
                                            <tr>
                                                ...
                                                <td><a
                                                        href="{{ url('patient_invoice', $customer->id) }}">{{ $customer->name }}</a>
                                                </td>
