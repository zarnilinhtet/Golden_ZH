        ...
        @include('layouts.sidebar') <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="ml-2 container-fluid">
                    ...
                    <!-- /.modal -->
                    <div class="row">
                        <a href="{{ url('report') }}" class="btn btn-primary ml-3 mx-2">Invoice</a>

                        <a href="{{ url('report_quotation') }}" class="btn btn-primary">Quotation</a>
                        <a href="{{ url('report_pos') }}" class="btn btn-primary mx-2">POS</a>
 <a href="{{ url('report_expense') }}" class="btn btn-primary">Expense</a>
                        <a href="{{ url('report_po') }}" class="btn btn-primary mx-2 ">Purchase Order</a>
