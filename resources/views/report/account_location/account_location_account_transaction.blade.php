                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h4 class="mb-3 ml-3" style="font-weight: bold">
                                            ...
                                            @foreach ($transaction as $transactions)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{ isset($diff[$transactions->id]) ? number_format($diff[$transactions->id]) : 0 }}
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <a href="{{ url('account_location_transaction_payment/' . $branch . '/' . $transactions->id) }}"
