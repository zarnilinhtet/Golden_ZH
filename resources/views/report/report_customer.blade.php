            ...
            <section class="content">
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item">Customer Report
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="ml-2 container-fluid">
                    ...
                    <div class="container-fluid mb-4">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ url('customer_report_search') }}" method="get">
                                    <div class="row">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                            ...
                                            $total_remaining += $customer->total_remain;
