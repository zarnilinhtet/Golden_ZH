                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="category">
                                                            ...
                                                            <option value="Sale Account (Invoice Return)">Sale Account
                                                                (Invoice Return)
                                                            </option>
                                                            <option value="Receivable (Invoice Return)">Receivable
                                                                (Invoice Return)
                                                            </option>

                                                            <option value="Sale Account (Invoice) ">Sale Account
                                                                (Invoice)
                                                            </option>
                                                            ...
                                                            {{-- <option value="Po Return">Po Return
                                                            </option> --}}
                                                            <option value="Buy Account (Purchase Order)">Purchase
                                                                Account
                                                                (Purchase Order)
                                                            </option>
                                                            ...
                                                            {{-- <option value="Other Income">Other Income
                                                            </option> --}}
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="phno">Location <span
                                                                class="text-danger">*</span></label>
                                                        <select class="form-control" name="branch_id" id="location">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($settings as $setting)
                                                <tr>
                                                    ...
                                                    <td>{{ $setting->warehouse ? $setting->warehouse->name : '' }}</td>
