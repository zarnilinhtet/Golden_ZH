        ...
        <div class="content-wrapper ">
            ...
            @if (in_array('Dashboard', $userPermissions) || auth()->user()->is_admin == '1')
                             ...
                             <div class="col ">
                                ...
                                <div class="small-box bg-warning">
                                    <div class="inner">
                                        ...
                                        <p class="d-block d-sm-none">{{ Str::limit('Customer', 8) }}</p>
                                        <p class="d-none d-sm-block">{{ 'Customer' }}</p>
                                    </div>
                                    <div class="icon">
                                        <i class="fa-solid fa-users"></i>
                                    </div>
                                    <a href="{{ url('customer') }}" class="small-box-footer">More info <i
                                            class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col ">
                                ...
                                <div class="small-box bg-info">
                                    <div class="inner">
                                        ...
                                        <p class="d-block d-sm-none">{{ Str::limit('New Customer', 8) }}</p>
                                        <p class="d-none d-sm-block">{{ 'New Customer' }}</p>
                                    </div>
                                    <div class="icon">
                ...
                <section class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mt-3 card-header col-12 col-md-6 col-lg-6">
                                            ...
                                            @forelse ($warrantyClaimCounts as $claim)
                                                <li
                                                    ...
                                                    <span style="font-size: 13px">
                                                        <strong>{{ $claim->part_number }}</strong>
                                                    </span>
                            ...
                            <div class="mt-3 card-header col-12 col-md-6 col-lg-6">
                                <div class="card h-100  bg-white">
                                    <div class="card-header">
                                        <h4 class="card-title text-center">
                                            <i class="fas fa-award me-2"></i>
                                            Top Sale Person and Amount for {{ \Carbon\Carbon::now()->format('F, Y') }}
                                        </h4>
                                    </div>
                                    <div class="card-body">
                                        <ol class="list-group list-group-numbered">
                                            @forelse ($SalePersons as $sale)
                                                <li
                                                    class="list-group-item d-flex justify-content-between align-items-center">
                                                    <span style="font-size: 13px">
                                                        <strong>{{$sale->SaleBy->name??'' }}</strong>
                                                    </span>
                                                    <span style="font-size: 13px" class="fw-bold">
                                                        {{ number_format($sale->total_net) }}
                                                    </span>
                                                </li>
                                            @empty
                                                <li class="list-group-item text-center">
                                                    <em>No Sale Person found for this month.</em>
                                                </li>
                                            @endforelse
                                        </ol>
                                    </div>
