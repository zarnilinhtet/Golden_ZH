                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item">Invoice Record</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card ">
                        <div class="card-header">
                            <h3 class="card-title">Invoice Record List</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($invoice_records as $record)
                                        <tr>
                                            ...
                                            <td>{{ $record->warehouse ? $record->warehouse->name : '' }}</td>
                                            <td>{{ $record->user ? $record->user->name : '' }}</td>
                                            <td>{{ \Carbon\Carbon::parse($record->date)->setTimezone('Asia/Yangon')->format('d-m-Y h:i A') }}
                                            </td>
                                        </tr>
                                    @endforeach
