{{-- <x-guest-layout>
    <!-- Session Status -->
    @if (session('error'))
        <span style="text-danger">{{ session('error') }}</span>
    @endif
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end">
            ...
            <x-primary-button class="mb-3 mt-3 btn btn-danger btn-sm shadow-lg rounded">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('backend/assets/images/coveverse.jpg') }}" />
...
<style>
    body {
        ...
        background-image: url('{{ asset('img/bgimg.jpg') }}');
        ...
        <section class="login-content">
            <div class="container">
                <div class="row align-items-center justify-content-center height-self-center">
                    <div class="col-lg-8">
                        {{-- <div class="card auth-card" style="background-color: #F2DFC8"> --}}
