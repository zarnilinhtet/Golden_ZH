            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    <div class="row  justify-content-center d-flex">
                        ...
                        @if (in_array('User Type Register', $userPermissions) || auth()->user()->is_admin == '1')
                            <div class="col-md-12 ">
                                            ...
                                            @foreach ($types as $key => $type)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (in_array('User Type Edit', $userPermissions) || auth()->user()->is_admin == '1')
                                                        ...
                                                        @if (in_array('User Type Delete', $userPermissions) || auth()->user()->is_admin == '1')
