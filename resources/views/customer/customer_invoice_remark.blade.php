            ...
            <section class="content">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="mb-2 row">
                            <div class="col-sm-6">
                                <h1 style="font-weight:bolder">Patient Name : {{ $customer->name }}</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item">Invoice List
                                    </li>
                                </ol>
                            </div>
                        </div>
                                            ...
                                            <tr data-status="{{ $invoice->status }}">
                                                ...
                                                <td>
                                                    @if ($invoice->doctor_id)
                                                        {{ $invoice->Doctor->name }}@else{{ '' }}
                                                    @endif
                                                </td>
                                                <td>{{ $invoice->treatment->diagnosis ?? '' }}</td>
                                                <td>{{ $invoice->treatment->investigation ?? '' }}</td>
                                                {{-- <td></td> --}}
                                            </tr>
                                        @endforeach
                                    </tbody>
