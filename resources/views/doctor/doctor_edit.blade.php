...
<body class="hold-transition sidebar-mini">
                                ...
                                <div class="card-body">
                                    <form action="{{ url('doctors_update', $supplier->id) }}" method="POST">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="sale_commission">Commission (Amount)</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control"
                                                    id="sale_commission_percentage" name="sale_commission_percentage"
                                                    value="{{ $supplier->sale_commission_percentage }}" required>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            $('#sale_commission').on('change', function() {
                if ($(this).val()) {
            ...
            $('#sale_commission_percentage').on('change', function() {
                if ($(this).val()) {
