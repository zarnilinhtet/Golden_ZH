        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="ml-2 container-fluid">
                    ...
                    @if (in_array('Supplier Register', $userPermissions) || auth()->user()->is_admin == '1')
                        <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        @if (in_array('Supplier Edit', $userPermissions) || auth()->user()->is_admin == '1')
                                                            <a href="{{ url('supplier_edit', $supplier->id) }}"
                                                                title="Supplier Edit" class="mx-2 btn btn-success"><i
                                                                    class="fa-solid fa-pen-to-square"></i></a>
                                                        @endif

                                                        @if (in_array('Supplier Delete', $userPermissions) || auth()->user()->is_admin == '1')
                                                            <a href="{{ url('supplier_delete', $supplier->id) }}"
                                                                title="Supplier Delete" class="mx-2 btn btn-danger"
